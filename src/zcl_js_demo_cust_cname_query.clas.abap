CLASS zcl_js_demo_cust_cname_query DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PRIVATE SECTION.
    TYPES:
      tt_result TYPE STANDARD TABLE OF ZJS_I_RAPCustomEntityCNames WITH EMPTY KEY.
...
CLASS ZCL_JS_DEMO_CUST_CNAME_QUERY IMPLEMENTATION.
  ...
  METHOD get_proxy.
    TRY.
        ...
        ro_result = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'ZJS_DEMO_RAP_ONPREM_ODATA'
            io_http_client             = lo_client
            iv_relative_service_root   = '/sap/opu/odata/sap/ZJS_API_COMPANY_NAMES_O2' ).
