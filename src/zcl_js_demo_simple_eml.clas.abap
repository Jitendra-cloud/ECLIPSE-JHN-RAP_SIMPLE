CLASS zcl_js_demo_simple_eml DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_js_demo_simple_eml IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      lt_selection TYPE TABLE FOR READ IMPORT ZJS_I_RAPPartner,
      lt_creation  TYPE TABLE FOR CREATE ZJS_I_RAPPartner,
      lt_update    TYPE TABLE FOR UPDATE ZJS_I_RAPPartner.
    ...
    READ ENTITIES OF ZJS_I_RAPPartner ENTITY Partner
    ...
    MODIFY ENTITIES OF ZJS_I_RAPPartner ENTITY Partner
